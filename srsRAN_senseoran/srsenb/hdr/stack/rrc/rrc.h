...
public:
  ...
  void start_custom_handover(uint16_t rnti, uint32_t target_enb);
...
typedef struct _handover_command_container {
  uint16_t rnti;
  uint32_t enb_id;
} handover_command_container_t, *phandover_command_container_t;
